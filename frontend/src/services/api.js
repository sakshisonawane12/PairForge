...
export const verifyRoomPassword = (code, password) => API.post(`/api/rooms/${code}/verify`, { password });
export const saveSnapshot = (code, data) => API.post(`/api/rooms/${code}/snapshot`, data);
...
export const createRoomFile = (code, data) => API.post(`/api/rooms/${code}/files`, data);
export const updateRoomFile = (code, fileName, data) => API.put(`/api/rooms/${code}/files/${fileName}`, data);
export const deleteRoomFile = (code, fileName) => API.delete(`/api/rooms/${code}/files/${fileName}`);
